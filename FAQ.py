...
description='''
No, you simply need to ensure that all your BOINC computers use the same email and are crunching for the Gridcoin team. Also doing that is an easy way to get your wallets banned by other gridcoin wallets.
''')
